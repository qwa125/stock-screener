...
exports.StockModule = StockModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [stock_service_1.StockService, data_fetcher_service_1.DataFetcherService],
        exports: [stock_service_1.StockService, data_fetcher_service_1.DataFetcherService],
    })
], StockModule);
